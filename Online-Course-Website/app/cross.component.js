System.register(['angular2/core', 'angular2/router'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            CrossComponent = (function () {
                function CrossComponent() {
                    this.total = 3000;
                    this.showTotal = false;
                }
                CrossComponent.prototype.onSelect = function () {
                    this.showTotal = true;
                };
                CrossComponent.prototype.abc = function (e) {
                ...
                CrossComponent.prototype.pqr = function (e) {
                    var isChecked = e.target.checked;
                    if (isChecked == true) {
                ...
                CrossComponent.prototype.nmo = function (e) {
                    var isChecked = e.target.checked;
                    if (isChecked == true) {
                        this.total = this.total + 200;
                    }
            ...
            exports_1("CrossComponent", CrossComponent);
        }
    }
});
